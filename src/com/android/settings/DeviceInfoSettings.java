...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    private static final String KEY_OM_VERSION = "om_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        findPreference(KEY_OM_VERSION).setEnabled(true);
        setValueSummary(KEY_OM_VERSION, "ro.om.version");
...
Log.i("EASTER",preference.getKey().toString());
        if (preference.getKey().equals(KEY_FIRMWARE_VERSION)) {
        ...
        } else if (preference.getKey().equals(KEY_OM_VERSION)) {
            ...
            if (mTaps[0] >= (SystemClock.uptimeMillis()-500)) {
                Intent intent = new Intent(Intent.ACTION_MAIN);
                intent.setClassName("android",
                        com.android.internal.app.OMActivity.class.getName());
                try {
                    startActivity(intent);
                } catch (Exception e) {
                    Log.e(LOG_TAG, "Unable to start activity " + intent.toString());
